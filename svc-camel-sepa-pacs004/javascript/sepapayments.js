load('E:/Pelican_Install_Dir/Pelican/ace.solution.ppay/svc-camel-sepa-pacs004/javascript/pelicanxmlutility.js');
load('E:/Pelican_Install_Dir/Pelican/ace.solution.ppay/svc-camel-sepa-pacs004/javascript/utility.js');
load('E:/Pelican_Install_Dir/Pelican/ace.solution.ppay/svc-camel-sepa-pacs004/javascript/authorizationCheck.js'); 
load('E:/Pelican_Install_Dir/Pelican/ace.solution.ppay/svc-camel-sepa-pacs004/javascript/messageRepair.js');
load('E:/Pelican_Install_Dir/Pelican/ace.solution.ppay/svc-camel-sepa-pacs004/javascript/cashForecasting.js');
load('E:/Pelican_Install_Dir/Pelican/ace.solution.ppay/svc-camel-sepa-pacs004/javascript/customRules.js');
...
function dbOperationSepaBatch(exchange) {
	...
	if(msgType === 'pacs.004.001.09') {
		...
		var txnIdPath = '/Document/PmtRtr/GrpHdr/MsgId';
		var txnId = getValueFromPath(Document, txnIdPath);
...
function dbOperationSepaError(exchange) {
	...
	setHeader(map, "PLCN_resubmitQueueId","CFRTNINQ");
